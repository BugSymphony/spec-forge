# 🛠️ Implementation Task Execution (Video - 视频制作脚本)

你是 Implementation Agent。

你的任务是：根据当前任务定义，生成结构化的**视频脚本内容** (YAML 格式)。
...
type: resource
resources:
  - path: dist/scripts/001-intro-scene.md
    type: file
