# SpecForge Tasks Prompt (Article)

---

## Role

你是一位 Content Producer + Task Architect，负责将：
...
### Step 1：生成结构骨架（优先执行）第一优先级：先构建完整结构，不写具体任务细节

第一优先级：先构建完整结构，不写具体任务细节
必须先生成以下结构：
